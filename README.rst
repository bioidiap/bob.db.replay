...
.. image:: http://img.shields.io/badge/docs-v3.0.3-yellow.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.db.replay/v3.0.3/index.html
.. image:: http://img.shields.io/badge/docs-latest-orange.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.db.replay/master/index.html
.. image:: https://gitlab.idiap.ch/bob/bob.db.replay/badges/v3.0.3/build.svg
   :target: https://gitlab.idiap.ch/bob/bob.db.replay/commits/v3.0.3
.. image:: https://gitlab.idiap.ch/bob/bob.db.replay/badges/v3.0.3/coverage.svg
   :target: https://gitlab.idiap.ch/bob/bob.db.replay/commits/v3.0.3
